...
///   모든 구조적 변경(Entity 생성/파괴 등)을 모아 한 번에 Playback.
/// - 여러 시스템이 각자 Playback을 호출하여 발생하던 다중 Sync Point를 1회로 압축.
/// - SynchronizationGroup(Phase 6) 진입 전에 모든 엔티티 상태가 월드에 완전히 반영되도록 보장.
/// </summary>
