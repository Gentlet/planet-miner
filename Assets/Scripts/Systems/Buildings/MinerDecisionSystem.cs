...
/// - 채굴기 내부 보관 버퍼(DynamicBuffer<StoredItemElement>)의 적재 수량과 Storage.SlotCount를 비교하여 여유 공간을 검사합니다.
...
/// - 외부 벨트로의 방출은 채굴기에 부착된 BuildingItemOutputDecision과 출고 시스템(BuildingItemOutputDecisionSystem)이 전담합니다.
/// </summary>
...
public partial struct MinerDecisionSystem : ISystem
{
    ...
    public void OnCreate(ref SystemState state)
    {
        ...
        _minerQuery = SystemAPI.QueryBuilder()
            ...
            .WithAll<MinerState, BuildingFootprint, GridPosition, Direction, Storage, StoredItemElement>()
...
public partial struct MinerDecisionJob : IJobEntity
{
        ...
        in Direction dir)
    {
        ...
        // 2. 내부 출력 버퍼 여유 공간 확인
        bool hasSpace = storedItems.Length < storage.SlotCount;
