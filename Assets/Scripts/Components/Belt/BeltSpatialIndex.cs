...
/// 
/// [책임]
/// - 그리드 좌표(int2)를 키로 하여 해당 위치에 배치된 벨트 건물의 정보를 O(1)에 조회.
/// - 벨트는 1타일에 1개만 배치되므로 NativeParallelHashMap 기반으로 구성.
/// - 순수 Resource(Map)만을 관리하며, 의존성 제어는 BeltSpatialIndexFence에 위임.
/// </summary>
